...
fun MyOrdersScreen(
    ...
    Scaffold(
        topBar = { SabziTopBar(title = "My Orders", canNavigateBack = true, onNavigateBack = onBackClick) }
    ) { padding ->
        Column(modifier = Modifier.padding(padding)) {
            ...
            Row(
                ...
                CustomerDateFilter.entries.forEach { option ->
                    FilterChip(
                        ...
                        label = {
                            Text(
                                when (option) {
                                    CustomerDateFilter.ALL -> "All"
                                    CustomerDateFilter.TODAY -> "Today"
                                    CustomerDateFilter.YESTERDAY -> "Yesterday"
                                },
                                fontSize = 13.sp,
            ...
            TabRow(selectedTabIndex = uiState.selectedTab) {
                MyOrdersViewModel.TABS.forEachIndexed { index, title ->
                    Tab(
